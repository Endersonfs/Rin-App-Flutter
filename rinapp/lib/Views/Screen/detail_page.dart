          ...
          children: [
            Container(
              ...
              child: IconButton(onPressed: (){
                ...
                Icons.shopping_cart,
                color: _plantList[widget.plantId].isSelected == true ? Colors.white : Constant.primaryColor,
              )),
              decoration: BoxDecoration(
                  color: _plantList[widget.plantId].isSelected == true ? Constant.primaryColor.withOpacity(.5) : Colors.white,
